...
do
	...
	function Skada:GetInstanceDiff()
		...
		elseif diff == 147 then -- normal bfa warfront
			return "nw"
		elseif diff == 148 or diff == 185 then -- 20man classic raid
			return "20n"
...
do
	...
	local SUFFIXES = {
		...
		HEAL_ABSORBED = ", extraGUID, extraName, extraFlags, extraRaidFlags, extraspellid, extraspellname, extraschool, absorbed, total",
		ABSORBED = ", casterGUID, casterName, casterFlags, casterRaidFlags, absorbSpellid, absorbSpellname, absorbSpellschool, amount, critical",
